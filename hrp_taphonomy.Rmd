...
```{r, fragmentation, fig.cap='Figure 3. Completeness Distribution by Region. The green areas represent nearly complete elements, the orange is for elements that are fragmented, and the purple represents complete elements.'}
