...
hd_chisq <- hadar_merge[,c("anatomical_region.y", "completeness")]
chisq_plot <- ggbarstats(data = hd_chisq, x = completeness, y = anatomical_region.y) + labs(caption=NULL) #show the preservation stats for each anatomical region; 729 observations
chisq_plot 
```
